...
//
internal partial class OculusBuildSamples
{
    private static TimeSpan? minThreshold = TimeSpan.FromSeconds(1);

    private static void ImportSamplesFramework() {
    ...
    private static void BuildDistanceGrab() {
    ...
    private static void BuildWidevineVideo() {
        AndroidVideoEditorUtil.EnableNativeVideoPlayer();
